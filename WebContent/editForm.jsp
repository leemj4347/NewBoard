			...
			<div class="board_write_wrap">
                <div class="board_write">
                    <form action="./edit.jsp" method="post">
                        ...
                        <dl class="content">
                            <dd>
                            	<textarea name="content" id="ir1" rows="10" cols="100" style="width:766px; height:412px;"><%=board.getContent()%></textarea>
                            </dd>
                        </dl>
                        <dl class="image">
                            <dt>사진</dt>
				...
				<div class="bt_wrap">
					<a href="javascript:insertBoard(this);" class="bt1 on">글쓰기</a>
